...
export default function Nav() {
  ...
  return (
    <nav className="pt-7 md:pt-[34px] flex justify-between items-center relative">
      {/* Logo */}
      <h1 className="text-2xl md:text-3xl font-fraunces text-red-400">mapula</h1>
